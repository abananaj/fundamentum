...
<p class="has-main-accent-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Explore fundamentum</p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-left has-main-accent-color has-text-color" style="font-style:normal;font-weight:400">Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the fundamentum block theme. No coding skills required.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button" href="https://fundamentumwp.com">Get Started Today →</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
