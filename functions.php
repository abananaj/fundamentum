...
wp_register_style('bootstrap-style', get_template_directory_uri() . '/librarium/dist/index.css');
 //empty array()for dependencies, version 0.1, place this in footer not head
wp_register_script('bootstrap-script', get_template_directory_uri() . '/librarium/dist/js/bootstrap.bundle.min.js', array(), true);
